...
data class PromotionGenerator(
    override val configuration: PromotionConfiguration,
    ...
    override val objects: Sequence<Promotion>
        get() {
            ...
            val productPromotions =
                if (configuration.productConfig != null) (1..configuration.productConfig.elementCount).asSequence().map {
            ...
            val orderPromotions =
                if (configuration.orderConfig != null) (1..configuration.orderConfig.elementCount).asSequence().map {
            ...
            val shippingPromotions =
                if (configuration.shippingConfig != null && shippingMethods != null) (1..configuration.shippingConfig.elementCount).asSequence().map {
                    ShippingPromotion(
                        shippingRng.nextLong(),
                        categoryIds,
                        catalog.id,
        ...
        get() {
            ...
            while (promotions.isNotEmpty()) {
                ...
                val campaign = Campaign(
                    ...
                    config = configuration.campaigns,
                    customerGroupIds = customerGroups.plus(defaultCustomerGroups),
                    couponIds = couponIds,
